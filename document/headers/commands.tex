...
\newcommand{\mycontributorhref}[2]
{{#2}\protect\footnote{    \begin{minipage}{\fnwidth} \ttfamily \url{#1}  \end{minipage}}} 


\newcommand{\mylofref}[2]
{#1\protect\footnote{\mychapterbabel {$\text{}$} \ref{#2} \mypagebabel {$\text{}$} \pageref{#2}}}
...
\newcommand{\myhref}[2]
{\protect\footnotetext[#1]{    \begin{minipage}{\fnwidth} \ttfamily \url{#2}  \end{minipage}}} 

\newcommand{\mylref}[2]
{\protect\footnotetext[#1]{\mychapterbabel {$\text{}$} \ref{#2} \mypagebabel {$\text{}$} \pageref{#2}}}
       ...
       \fp_eval:n
         {
           ( 
            ...
            - \dim_to_decimal:n{2\tabcolsep+\arrayrulewidth}
           )*#1
         } pt
      }
  }        
