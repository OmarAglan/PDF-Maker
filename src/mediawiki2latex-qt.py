...
class MainWindow (QWidget):
    ...
    def callbackthreadrun(self):
        ...
        """
        p=subprocess.Popen(["mediawiki2latex","-u",self.edit.text(),"-o", "main.pdf",self.getSwitch(self.combo.itemText(self.combo.currentIndex())),"-p",self.papercombo.itemText(self.papercombo.currentIndex()),self.getVector(self.rastercombo.itemText(self.rastercombo.currentIndex()))],stdout=subprocess.PIPE )
        f=(p.stdout)
        r=b"X"
        while r!=b"":
          r=f.readline()
