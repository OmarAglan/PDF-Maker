...
data MyState = MyState{getImages :: [String], getJ :: Int,
                       ...
                       forms :: Map String Int, lastChar :: Char, lastFontChanged :: Bool, getCaptionLevel :: Integer, vector:: Bool, htmlTables :: [String], latexTabs :: Bool, htmlMaps::[String], htmlColors::Map String String, isSpaceIndent :: Bool, footnoteMap::Map Integer String, footnoteNumber::Integer, styles::[Anything Char]}
...
initialState
  = MyState{getImages = [], getJ = 1, getF = 1, getC = 1,
            ...
            lastChar = ' ', lastFontChanged = False, getCaptionLevel=0, vector=False,htmlTables=[], latexTabs=False,htmlMaps=[],htmlColors=Map.empty,isSpaceIndent=False, footnoteMap=Map.empty, footnoteNumber=1, styles=[]}
